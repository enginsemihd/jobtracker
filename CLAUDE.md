...
Bu, kişisel bir iş başvurusu takip uygulamasıdır. AI ile özgeçmiş/ön yazı uyarlama (Claude) ve çok kaynaklı iş arama (Jooble, Adzuna, Remotive, RemoteOK) içerir. Avrupa + Türkiye pazarına odaklıdır.
...
DATABASE_URL, PORT (8080), ANTHROPIC_API_KEY, JOOBLE_API_KEY, (opsiyonel) ADZUNA_APP_ID/ADZUNA_APP_KEY
